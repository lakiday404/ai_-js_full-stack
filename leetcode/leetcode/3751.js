...
function totalWaviness(num1, num2) {
    ...
    for (let n = num1; n <= num2; n++) {
        ...
        for (let i = 1; i < s.length - 1; i++) {
            ...
            if (curr > prev && curr > next) total++; // 峰
            if (curr < prev && curr < next) total++; // 谷
        }
    }
...
console.log(totalWaviness(1, 10));        // 0
console.log(totalWaviness(100, 100));     // 0  (100 没有峰谷)